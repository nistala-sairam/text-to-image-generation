...
class StackGanStage1(object):
  ...
  def __init__(self, epochs=1000, z_dim=100, batch_size=64, enable_function=True, stage1_generator_lr=0.0002, stage1_discriminator_lr=0.0002):
      self.epochs = epochs
      self.z_dim = z_dim
  ...
  def train_stage1(self):
      ...
      self.stage1_generator.load_weights('modelweigths/stage1_gen.h5');
      self.stage1_discriminator.load_weights("modelweigths/stage1_disc.h5")
      self.ca_network.load_weights('modelweigths/stage1_ca.h5')
      self.embedding_compressor.load_weights('modelweigths/stage1_embco.h5')
      self.stage1_adversarial.load_weights('modelweigths/stage1_adv.h5')
          ...
          for i in range(num_batches):
            ...
            if epoch % 5 == 0:
                    ...
                    for i, image in enumerate(gen_images[:10]):
                        save_image(image, f'stageoneoutput/gen_1_{epoch}_{i}')

            if epoch % 5 == 0:
              self.stage1_generator.save_weights('modelweigths/stage1_gen.h5')
              self.stage1_discriminator.save_weights("modelweigths/stage1_disc.h5")
              self.ca_network.save_weights('modelweigths/stage1_ca.h5')
              self.embedding_compressor.save_weights('modelweigths/stage1_embco.h5')
              self.stage1_adversarial.save_weights('modelweigths/stage1_adv.h5') 
...
def build_stage2_discriminator():
    ...
    x = ConvBlock(x, 128, strides=4)
    # Comment below
    # x = ConvBlock(x, 256)
    x = ConvBlock(x, 512, strides = 4)
    # Comment below
    # x = ConvBlock(x, 1024)
    x = ConvBlock(x, 2048)
    # Comment below
...
print('Stage 2 Adversial Network')
...
class StackGanStage2(object):
    ...
    """
    def __init__(self, epochs=500, z_dim=100, batch_size=32, enable_function=True, stage2_generator_lr=0.0002, stage2_discriminator_lr=0.0002):
        self.epochs = epochs
        self.z_dim = z_dim
        self.enable_function = enable_function
    ...
    def train_stage2(self):
      ...
      dataset_path=dataset_path, embeddings_path=embeddings_path_test, size=(64, 64))
        ...
        self.stage2_generator.load_weights('modelweigths/stage2_gen.h5')
        self.stage2_discriminator.load_weights(
            "modelweigths/stage2_disc.h5")
        self.ca_network.load_weights('modelweigths/stage2_ca.h5')
        self.embedding_compressor.load_weights(
            'modelweigths/stage2_embco.h5')
        self.stage2_adversarial.load_weights(
            'modelweigths/stage2_adv.h5')
        epoch = 35
            ...
            for i in range(num_batches):
                ...
                if epoch % 5 == 0:
                    ...
                    for i, image in enumerate(high_fake_images[:10]):
                        save_image(image, f'stagetwooutput/gen_{epoch}_{i}.png')

                if epoch % 5 == 0:
                    self.stage2_generator.save_weights('modelweigths/stage2_gen.h5')
                    self.stage2_discriminator.save_weights(
                        "modelweigths/stage2_disc.h5")
                    self.ca_network.save_weights('modelweigths/stage2_ca.h5')
        ...
        self.stage2_generator.save_weights('modelweigths/stage2_gen.h5')
        self.stage2_discriminator.save_weights("modelweigths/stage2_disc.h5")
